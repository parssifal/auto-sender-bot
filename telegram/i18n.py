...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "limit_posts": "⚠️ You've reached the limit of {limit} scheduled posts. Cancel some from your queue, or upgrade your plan for higher limits, then try again.",
        "limit_drafts": "⚠️ You've reached the limit of {limit} drafts. Delete some drafts, or upgrade your plan for higher limits, then try again.",
        "limit_destinations": "⚠️ You've reached the limit of {limit} linked channels/chats. Unlink some, or upgrade your plan for higher limits, then try again.",
        "limit_recurring": "⚠️ You've reached the limit of {limit} recurring posts. Cancel some, or upgrade your plan for higher limits, then try again.",
    ...
    "ru": {
        ...
        "limit_posts": "⚠️ Достигнут лимит запланированных постов ({limit}). Отмените часть в очереди или повысьте тариф для увеличения лимитов, затем попробуйте снова.",
        "limit_drafts": "⚠️ Достигнут лимит черновиков ({limit}). Удалите часть или повысьте тариф для увеличения лимитов, затем попробуйте снова.",
        "limit_destinations": "⚠️ Достигнут лимит привязанных каналов/чатов ({limit}). Отвяжите часть или повысьте тариф для увеличения лимитов, затем попробуйте снова.",
        "limit_recurring": "⚠️ Достигнут лимит повторяющихся постов ({limit}). Отмените часть или повысьте тариф для увеличения лимитов, затем попробуйте снова.",
